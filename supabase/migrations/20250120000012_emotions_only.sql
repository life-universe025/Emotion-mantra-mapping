-- Populate only the emotions table using data from emotions.ts file
-- This migration focuses only on emotions, not mantras

-- Insert emotions with ON CONFLICT to avoid duplicates
