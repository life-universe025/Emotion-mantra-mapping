    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 flex items-center justify-center p-4 pt-20 z-40">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full max-h-[calc(90vh-5rem)] overflow-y-auto overflow-x-hidden relative">
        ...
        <div className="p-6">
          ...
          {/* Success Message */}
          {isSuccess && (
            <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg animate-in fade-in slide-in-from-top-2 duration-500">
              <div className="flex items-center justify-center space-x-2">
                <IoCheckmarkCircle className="w-5 h-5 text-green-600 dark:text-green-400 animate-pulse" />
