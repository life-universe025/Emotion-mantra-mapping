...
export function MoodComparison({ moodData, className = '' }: MoodComparisonProps) {
  ...
  return (
    <div className={`bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-purple-900/20 dark:via-blue-900/20 dark:to-indigo-900/20 rounded-lg p-1.5 border border-purple-200/50 dark:border-purple-800/50 shadow-sm backdrop-blur-sm relative overflow-hidden ${className}`}>
      <div className="relative">
        {/* Compact header */}
        <div className="text-center mb-1">
          <h4 className="text-[10px] font-semibold text-gray-700 dark:text-gray-300 tracking-wide">
        ...
        <div className="flex items-center justify-between min-w-0">
          ...
          <div className="flex flex-col items-center space-y-0.5 flex-shrink-0">
            <div className={`
              p-1 rounded-md border-2 ${moodData.before_mood.color}
              shadow-sm hover:shadow-md transition-all duration-200
              relative overflow-hidden
            `}>
              <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
              <span className="text-sm relative z-10">{moodData.before_mood.emoji}</span>
            </div>
            <div className="text-center">
              <p className="text-[8px] font-medium text-gray-500 dark:text-gray-400 tracking-wide uppercase">
          ...
          <div className="flex flex-col items-center space-y-0.5 px-0.5 flex-shrink-0">
            <div className="relative">
              <IoArrowForward className="w-2.5 h-2.5 text-purple-400 dark:text-purple-300" />
            </div>
            <div className={`
              flex items-center space-x-0.5 px-1 py-0.5 rounded-full text-[8px] font-medium whitespace-nowrap
            ...
            {improvement !== 0 && (
              <div className={`
                px-1 py-0.5 rounded-full text-[9px] font-semibold whitespace-nowrap
          ...
          <div className="flex flex-col items-center space-y-0.5 flex-shrink-0">
            <div className={`
              p-1 rounded-md border-2 ${moodData.after_mood.color}
              shadow-sm hover:shadow-md transition-all duration-200
              relative overflow-hidden
            `}>
              <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
              <span className="text-sm relative z-10">{moodData.after_mood.emoji}</span>
            </div>
            <div className="text-center">
              <p className="text-[8px] font-medium text-gray-500 dark:text-gray-400 tracking-wide uppercase">
        ...
        {isImproved && (
          <div className="mt-1 text-center">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-md p-1 border border-green-200/50 dark:border-green-700/50">
              <p className="text-[9px] text-green-700 dark:text-green-300 font-medium">
